/**
 * @author Vtronics Automation <rnd.vtronicsautomation@gmail.com>
 */
(function ($) {
    "use strict";
...
var myModal = new bootstrap.Modal(
    document.getElementById("audioConfirmationModal"),
    {}
);
...
var countDownDate = new Date("May 22, 2023 06:30:00").getTime();
...
console.log("\n\n%c SAVE THE DATE: 22nd May, 2023!", styles);

console.log(
    "%cYour presence is requested!%c\n\nRegards: Vtronics Automation",
    styles1,
    styles2
);
